...
from bril.bril_extract import phi_nodes_get, values_get
...
from bril.dominance_analysis import (
    DominanceAnalysis,
...
from bril.typing_bril import BrilType, Effect, Instruction, Program, Value, Variable
